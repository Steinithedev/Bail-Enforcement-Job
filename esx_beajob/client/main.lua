...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'trainee' then
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i = 1, #Config.beaStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.beaStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory',
      ...
      function(data, menu)
        ...
        elseif (weapon == "SCEMFGS") then
          ...
          TriggerServerEvent('esx_beajob:giveWeapon', weapon, 1000)
        end
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  local vehicles = Config.beaStations[station].Vehicles
  ...
  if Config.EnableSocietyOwnedVehicles then
      ...
      ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_spawner',
        ...
        function(data, menu)
          ...
          if (PlayerData.job.grade >= vehicles[partNum].rank) then
            ...
            TriggerServerEvent('esx_society:removeVehicleFromGarage', 'bea', vehicleProps)
          else
            -- ERROR
    ...
    for i = 1, #Config.beaStations[station].AuthorizedVehicles, 1 do
      local vehicle = Config.beaStations[station].AuthorizedVehicles[i]
...
function OpenbeaActionsMenu()

  ESX.UI.Menu.CloseAll()

  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'bea_actions',
    {
      title = 'Bail Enforcement',
      align = 'top-left',
      elements = {
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'softcuff' then
                local target, distance = ESX.Game.GetClosestPlayer()
					...
					local target_id = GetPlayerServerId(target)
						...
						TriggerServerEvent('esx_beajob:requestarrest', target_id, playerheading, playerCoords, playerlocation)
					 end
                ...
                local target, distance = ESX.Game.GetClosestPlayer()
					...
					local target_id = GetPlayerServerId(target)
						TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3, 'cuff', 1.0)
						TriggerServerEvent('esx_beajob:requesthard', target_id, playerheading, playerCoords, playerlocation)
					end
				...
				local target, distance = ESX.Game.GetClosestPlayer()
					...
					playerCoords = GetEntityCoords(GetPlayerPed(-1))
					local target_id = GetPlayerServerId(target)
						TriggerServerEvent('esx_beajob:requestrelease', target_id, playerheading, playerCoords, playerlocation)
						Citizen.Wait(1200)
						TriggerServerEvent('InteractSound_SV:PlayWithinDistance', 3, 'uncuff', 0.5)
				end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_beajob:drag', GetPlayerServerId(closestPlayer))
					Citizen.Wait(800)
              ...
              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_beajob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_beajob:OutVehicle', GetPlayerServerId(player))
              end
...
function openbea()
  if PlayerData.job ~= nil and PlayerData.job.name == 'bea' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bea_actions') and (GetGameTimer() - GUI.Time) > 150 then
    OpenbeaActionsMenu()
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_beajob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'body_search',
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_beajob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_beajob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category',
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_bea', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_beajob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_beajob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_get_weapon',
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_beajob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_put_weapon',
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_beajob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
    end,
    function(data, menu)
  ...
  ESX.TriggerServerCallback('esx_beajob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'armory_buy_weapons',
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_beajob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_beajob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_get_item_count',
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_beajob:getStockItem', itemName, count)
            end
          end,
          function(data2, menu2)
            menu2.close()
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_beajob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'stocks_menu_put_item_count',
          ...
          function(data2, menu2)
            ...
            if count == nil or count < 1 then
              ...
              TriggerServerEvent('esx_beajob:putStockItems', itemName, count)
            end
          end,
          function(data2, menu2)
            menu2.close()
...
AddEventHandler('esx_beajob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.beaStations[station].Helicopters
...
AddEventHandler('esx_beajob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_beajob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'bea' and not IsPedInAnyVehicle(playerPed, false) then
    CurrentAction = 'remove_entity'
    CurrentActionMsg = _U('remove_object')
    CurrentActionData = { entity = entity }
  end

  if GetEntityModel(entity) == GetHashKey('p_ld_stinger_s') and PlayerData.job.name ~= 'bea' then
...
AddEventHandler('esx_beajob:hasExitedEntityZone', function(entity)
...
--[[
RegisterNetEvent('esx_beajob:handcuff')
AddEventHandler('esx_beajob:handcuff', function()
...
RegisterNetEvent('esx_beajob:drag')
AddEventHandler('esx_beajob:drag', function(cop)
...
RegisterNetEvent('esx_beajob:unrestrain')
AddEventHandler('esx_beajob:unrestrain', function()
	if IsHandcuffed then
		local playerPed = PlayerPedId()
		IsHandcuffed = false
...
RegisterNetEvent('esx_beajob:hardcuff')
AddEventHandler('esx_beajob:hardcuff', function()
	local playerPed = PlayerPedId()
	Citizen.CreateThread(function()
		if IsShackles then
			if Config.EnableHandcuffTimer then
...
RegisterNetEvent('esx_beajob:drag')
AddEventHandler('esx_beajob:drag', function(copID)
...
RegisterNetEvent('esx_beajob:putInVehicle')
AddEventHandler('esx_beajob:putInVehicle', function()
...
RegisterNetEvent('esx_beajob:OutVehicle')
AddEventHandler('esx_beajob:OutVehicle', function(t)
...
RegisterNetEvent('esx_beajob:getarrested')
AddEventHandler('esx_beajob:getarrested', function(playerheading, playercoords, playerlocation)
	...
	IsHandcuffed = true
	IsShackles = false
	TriggerEvent('esx_beajob:handcuff')
	LoadAnimDict('mp_arresting')
	TaskPlayAnim(GetPlayerPed(-1), 'mp_arresting', 'idle', 8.0, -8, -1, 49, 0.0, false, false, false)
end)


RegisterNetEvent('esx_beajob:doarrested')
AddEventHandler('esx_beajob:doarrested', function()
	Citizen.Wait(250)
	LoadAnimDict('mp_arrest_paired')
...
RegisterNetEvent('esx_beajob:douncuffing')
AddEventHandler('esx_beajob:douncuffing', function()
	Citizen.Wait(250)
	LoadAnimDict('mp_arresting')
...
RegisterNetEvent('esx_beajob:getuncuffed')
AddEventHandler('esx_beajob:getuncuffed', function(playerheading, playercoords, playerlocation)
	local x, y, z   = table.unpack(playercoords + playerlocation * 1.0)
	SetEntityCoords(GetPlayerPed(-1), x, y, z)
	SetEntityHeading(GetPlayerPed(-1), playerheading)
	Citizen.Wait(250)
...
RegisterNetEvent('esx_beajob:loose')
AddEventHandler('esx_beajob:loose', function(playerheading, playercoords, playerlocation)
	local x, y, z   = table.unpack(playercoords + playerlocation * 1.0)
	SetEntityCoords(GetPlayerPed(-1), x, y, z)
	SetEntityHeading(GetPlayerPed(-1), playerheading)
	Citizen.Wait(250)
...
RegisterNetEvent('esx_beajob:getarrestedhard')
AddEventHandler('esx_beajob:getarrestedhard', function(playerheading, playercoords, playerlocation)
	playerPed = GetPlayerPed(-1)
	SetCurrentPedWeapon(playerPed, GetHashKey('WEAPON_UNARMED'), true)
	local x, y, z   = table.unpack(playercoords + playerlocation * 1.0)
	SetEntityCoords(GetPlayerPed(-1), x, y, z)
	...
	IsHandcuffed = true
	IsShackles = true
	TriggerEvent('esx_beajob:hardcuff')
	LoadAnimDict('mp_arresting')
	TaskPlayAnim(GetPlayerPed(-1), 'mp_arresting', 'idle', 8.0, -8, -1, 49, 0.0, false, false, false)
end)
...
Citizen.CreateThread(function()
  ...
  for k, v in pairs(Config.beaStations) do
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'bea' then
      ...
      for k, v in pairs(Config.beaStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'bea' and PlayerData.job.grade_name == 'boss' then
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'bea' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
        ...
        if (LastStation ~= nil and LastPart ~= nil and LastPartNum ~= nil) and
          ...
          TriggerEvent('esx_beajob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_beajob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_beajob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_beajob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
    end
  end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'bea' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'bea', vehicleProps)

          else

            if GetEntityModel(vehicle) == GetHashKey('bea') or
              GetEntityModel(vehicle) == GetHashKey('bea2') or
              GetEntityModel(vehicle) == GetHashKey('bea3') or
              GetEntityModel(vehicle) == GetHashKey('bea4') or
              GetEntityModel(vehicle) == GetHashKey('beab') or
              GetEntityModel(vehicle) == GetHashKey('beat') then
              TriggerServerEvent('esx_service:disableService', 'bea')
            end
          end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'bea', function(data, menu)
    ...
    if IsControlPressed(0, Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'bea' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bea_actions') and (GetGameTimer() - GUI.Time) > 150 then
      OpenbeaActionsMenu()
      GUI.Time = GetGameTimer()
    end
  end
...
function StartHandcuffTimer()
	...
	HandcuffTimer.Task = ESX.SetTimeout(Config.HandcuffTimer, function()
		...
		TriggerEvent('esx_beajob:unrestrain')
